...
package com.jk.my.rounde.iv;

import static com.jk.my.rounde.iv.RoundedDrawable.CORNER_BOTTOM_LEFT;
import static com.jk.my.rounde.iv.RoundedDrawable.CORNER_BOTTOM_RIGHT;
import static com.jk.my.rounde.iv.RoundedDrawable.CORNER_TOP_LEFT;
import static com.jk.my.rounde.iv.RoundedDrawable.CORNER_TOP_RIGHT;
...
public class RoundedImageView extends NetworkImageView {
	...
	public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		float cornerRadiusOverride = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius, -1);

		mCornerRadii[CORNER_TOP_LEFT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius_top_left, -1);
		mCornerRadii[CORNER_TOP_RIGHT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius_top_right, -1);
		mCornerRadii[CORNER_BOTTOM_RIGHT] = a
				.getDimensionPixelSize(
						R.styleable.RoundedImageView_riv_corner_radius_bottom_right,
						-1);
		mCornerRadii[CORNER_BOTTOM_LEFT] = a.getDimensionPixelSize(
				R.styleable.RoundedImageView_riv_corner_radius_bottom_left, -1);
		...
		mMutateBackground = a.getBoolean(
